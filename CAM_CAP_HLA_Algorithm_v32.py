        ...
        if Position == "1":  # I2 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    thresholdPixel_LeftSide_2 = 95#93#89#81#75#65#50
                    ...
                    #Left I2, LeftSide_Cet_4cy is -73, yminTL 156 ymaxTL: 449, ymaxRTL: 359, yminRTL: 99, thresholdPixel_LeftSide_1: 56, thresholdPixel_LeftSide_2: 89
                    #Left I2, LeftSide_Cet_4cy is -73, yminTL 156 ymaxTL: 449, ymaxRTL: 359, yminRTL: 99, thresholdPixel_LeftSide_1: 56, thresholdPixel_LeftSide_2: 89
                    #Left I2, LeftSide_Cet_4cy is -78, yminTL 138 ymaxTL: 429, ymaxRTL: 335, yminRTL: 76, thresholdPixel_LeftSide_1: 56, thresholdPixel_LeftSide_2: 93
            ...
            try:              
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    thresholdPixel_RightSide_1 = 92#82#75#67#61#57#45#35
                    thresholdPixel_RightSide_2 = 58#60#60#52#45#38
                    HlaSize = ymaxTR -yminTR
                    ymin_R_Value = yminTR -yminRTR
                    ymax_R_Value = ymaxTR -ymaxRTR
                    RightSide_Cet = cy -Rcy #ok 27 ok 54
                    if yminRTR > 890:
                        thresholdPixel_RightSide_2 = 70
                    ...
                    #Right I2,ymax_R_Value is 90 RightSide_Cet is 69 yminTR is 744 yminRTR 696, ymaxTR: 1050, ymaxRTR: 960, thresholdPixel_RightSide_1: 82, thresholdPixel_RightSide_2: 60
                    #Right I2,ymax_R_Value is -29 RightSide_Cet is -46 yminTR is 834 yminRTR 897, ymaxTR: 1146, ymaxRTR: 1175, thresholdPixel_RightSide_1: 92, thresholdPixel_RightSide_2: 60
        ...
        if Position == "1":  # I2 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    thresholdPixel_LeftSide_2 = 40#33#30#50#47
                    LeftSide_Cet = Lcy - cy   
                    ...
                    #Left I2, LeftSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is -19, yminTL 0 ymaxTL: 213, ymaxRTL: 175, yminRTL: 0, thresholdPixel_LeftSide_1: 30, thresholdPixel_LeftSide_2: 33
                    #Left I2, LeftSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is -28, yminTL 22 ymaxTL: 277, ymaxRTL: 241, yminRTL: 2, thresholdPixel_LeftSide_1: 30, thresholdPixel_LeftSide_2: 33
                    #Left I2, LeftSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is -28, yminTL 22 ymaxTL: 277, ymaxRTL: 241, yminRTL: 2, thresholdPixel_LeftSide_1: 30, thresholdPixel_LeftSide_2: 33
        ...
        if Position == "2":  # I3 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    if ymaxTL > 320:
                        thresholdPixel_LeftSide_2 = 24#22#25#38 #40
                    ...
                    #Left I3, LeftSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is ymaxTL: 321, yminTL 66 yminRTL 53 ymaxRTL: 296, thresholdPixel_LeftSide_1: 22, thresholdPixel_LeftSide_2: 22
...
#                     #Right E4,RightSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is SizeOf_cy_line is 1, Check_Line_distance_with_hla is 97,Check_Line_distance_with_hla_ymin is 99 yminTR is 867 yminRTR 896, ymaxTR: 1128, ymaxRTR: 1145, thresholdPixel_RightSide_1: 45, thresholdPixel_RightSide_2: 21
                    ...
                    #Right E4,RightSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is SizeOf_cy_line is 2, Check_Line_distance_with_hla is 90,Check_Line_distance_with_hla_ymin is 95 yminTR is 768 yminRTR 772, ymaxTR: 1020, ymaxRTR: 1018, thresholdPixel_RightSide_1: 45, thresholdPixel_RightSide_2: 30
                    #Right E4,RightSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is SizeOf_cy_line is 4, Check_Line_distance_with_hla is 92,Check_Line_distance_with_hla_ymin is 101 yminTR is 783 yminRTR 790, ymaxTR: 1037, ymaxRTR: 1029, thresholdPixel_RightSide_1: 45, thresholdPixel_RightSide_2: 30


                    if yminTR < (yminRTR - thresholdPixel_RightSide_1) or ymaxTR > (ymaxRTR + thresholdPixel_RightSide_2) or SizeOf_cy_line > 19 or Check_Line_distance_with_hla > 94 or Check_Line_distance_with_hla_ymin < 80:
                        HLA_POSTION_RIGHT = "NOT OK"
                        logger.debug(f"HLA_POSTION_RIGHT = NOT OK")
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTR, yminTR), (xmaxTR, ymaxTR), color, 12)
        ...
        if Position == "6":  # E3 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    thresholdPixel_LeftSide_2 = 90#80#30
                    ...
                    #Left E3,LeftSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is SizeOf_cy_line is 5 Check_Line_distance_with_hla is 92,Check_Line_distance_with_hla_ymin is 102 Check_Line_distance_with_hla is 92, Check_Line_distance_with_hla_ymin is 102 ymaxTL: 407,yminTL 143 yminRTL 75 ymaxRTL: 323, thresholdPixel_LeftSide_1: 21, thresholdPixel_LeftSide_2: 80
            ...
            try:  
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    thresholdPixel_RightSide_2 = 25#20
                    SizeOf_cy_line = cy_line -cy   # ok 8
                    ...
                    #Right E3, RightSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is SizeOf_cy_line is 0 Check_Line_distance_with_hla is 94,Check_Line_distance_with_hla_ymin is 95 yminTR is 744 yminRTR 746, ymaxTR: 996, ymaxRTR: 996,thresholdPixel_RightSide_1: 40, thresholdPixel_RightSide_2: 20
                    #Right E3, RightSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is SizeOf_cy_line is 1 Check_Line_distance_with_hla is 96,Check_Line_distance_with_hla_ymin is 99 yminTR is 770 yminRTR 777, ymaxTR: 1020, ymaxRTR: 1023,thresholdPixel_RightSide_1: 40, thresholdPixel_RightSide_2: 20
                    #Right E3, RightSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is SizeOf_cy_line is 6 Check_Line_distance_with_hla is 89,Check_Line_distance_with_hla_ymin is 101 yminTR is 700 yminRTR 693, ymaxTR: 955, ymaxRTR: 934,thresholdPixel_RightSide_1: 40, thresholdPixel_RightSide_2: 20


                    if yminTR < (yminRTR - thresholdPixel_RightSide_1) or ymaxTR > (ymaxRTR + thresholdPixel_RightSide_2) or SizeOf_cy_line > 21 or Check_Line_distance_with_hla > 97 or Check_Line_distance_with_hla_ymin < 80: 
                        HLA_POSTION_RIGHT = "NOT OK"
                        logger.debug(f"HLA_POSTION_RIGHT = NOT OK")
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTR, yminTR), (xmaxTR, ymaxTR), color, 12)
        ...
        if Position == "7":  # E2 position check
            ...
            try:
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    #Right E2,RightSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 SizeOf_cy_line is -1 Check_Line_distance_with_hla is 99,Check_Line_distance_with_hla_ymin is 98 is yminTR is 743 yminRTR 739, ymaxTR: 997, ymaxRTR: 983, thresholdPixel_RightSide_1: 30, thresholdPixel_RightSide_2: 35


                    if yminTR < (yminRTR - thresholdPixel_RightSide_2) or ymaxTR > (ymaxRTR + thresholdPixel_RightSide_1) or SizeOf_cy_line > 18 or Check_Line_distance_with_hla > halrod_gap_withhla  or Check_Line_distance_with_hla_ymin < 80:
                        HLA_POSTION_RIGHT = "NOT OK"
                        logger.debug(f"HLA_POSTION_RIGHT = NOT OK")
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTR, yminTR), (xmaxTR, ymaxTR), color, 12)
        ...
        if Position == "8":  # E1 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    #Left E1, LeftSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is SizeOf_cy_line is 5 Check_Line_distance_with_hla is 92, Check_Line_distance_with_hla_ymin is 101 ymaxTL: 386,yminTL 123 yminRTL 58 ymaxRTL: 309, thresholdPixel_LeftSide_1: 20, thresholdPixel_LeftSide_2: 96

       
                    if yminTL < (yminRTL - thresholdPixel_LeftSide_1) or ymaxTL > (ymaxRTL + thresholdPixel_LeftSide_2) or SizeOf_cy_line > 19 or Check_Line_distance_with_hla > 93 or Check_Line_distance_with_hla_ymin < 85:
                        logger.debug(f"HLA_POSTION_LEFT = NOT OK")
                        HLA_POSTION_LEFT = "NOT OK"
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTL, yminTL), (xmaxTL, ymaxTL), color, 12)
            ...
            try:              
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    thresholdPixel_RightSide_1 = 39#35
                    ...
                    #Right E1, RightSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is SizeOf_cy_line is 5 Check_Line_distance_with_hla is 92,Check_Line_distance_with_hla_ymin is 102 yminTR is 631 yminRTR 607, ymaxTR: 891, ymaxRTR: 855, thresholdPixel_RightSide_1: 35, thresholdPixel_RightSide_2: 45
                    #Right E1, RightSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is SizeOf_cy_line is 3 Check_Line_distance_with_hla is 98,Check_Line_distance_with_hla_ymin is 104 yminTR is 738 yminRTR 725, ymaxTR: 997, ymaxRTR: 967, thresholdPixel_RightSide_1: 39, thresholdPixel_RightSide_2: 45
                    #Right E1, RightSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is SizeOf_cy_line is 3 Check_Line_distance_with_hla is 97,Check_Line_distance_with_hla_ymin is 104 yminTR is 725 yminRTR 725, ymaxTR: 985, ymaxRTR: 967, thresholdPixel_RightSide_1: 39, thresholdPixel_RightSide_2: 45

                    if yminTR < (yminRTR - thresholdPixel_RightSide_2) or ymaxTR > (ymaxRTR + thresholdPixel_RightSide_1) or SizeOf_cy_line > 21 or Check_Line_distance_with_hla > 98 or Check_Line_distance_with_hla_ymin < 85:
                        HLA_POSTION_RIGHT = "NOT OK"
                        logger.debug(f"HLA_POSTION_RIGHT = NOT OK")
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTR, yminTR), (xmaxTR, ymaxTR), color, 12)
        ...
        if Position == "6":  # E1 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    if ymaxTL < (ymaxRTL - thresholdPixel_LeftSide_1) or ymaxTL > (ymaxRTL + thresholdPixel_LeftSide_2) or Check_Line_distance_with_hla > 99 or Check_Line_distance_with_hla_ymin < 90 or Check_Line_distance_with_hla_ymin > 120 or SizeOf_cy_line > 30:#Check_Line_distance_with_hla 97
                        HLA_POSTION_LEFT = "NOT OK"
                        ...
                        try:
                            if len(img_list) >= 8:
                                            ...
                                            if HLA_PostionCheck_pos1 == "OK" and CAM_CAP_NUMBER_STATUS_POS1 == "OK" and class_check_cam1 is True:
                                              ...
                                              # putText_notok_ok("CamCap is OK",original_image, pos)
                                                ...
                                                if CAM_CAP_NUMBER_STATUS_POS1 == "NOT OK" or class_check_cam1 is False :
                                                    pos = (50, 60)
                                                    putText_notok_ok("CAM_CAP_I1 is NotOK",original_image, pos)
                                            ...
                                            if HLA_PostionCheck_pos2 == "OK" and CAM_CAP_NUMBER_STATUS_POS2 == "OK" and class_check_cam1 is True:
                                               ...
                                               # putText_notok_ok("CamCap is OK",original_image, pos)
                                                ...
                                                if CAM_CAP_NUMBER_STATUS_POS2 == "NOT OK" or class_check_cam1 is False :
                                                    pos = (50, 60)
                                                    putText_notok_ok("CAM_CAP_I2 is NotOK",original_image, pos)
                                        ...
                                        if position == "3":#=============== I4                                         
                                            ...
                                            if HLA_PostionCheck_pos3 == "OK" and CAM_CAP_NUMBER_STATUS_POS3 == "OK" and class_check_cam1 is True:
                                                ...
                                                if CAM_CAP_NUMBER_STATUS_POS3 == "NOT OK" or class_check_cam1 is False :
                                                    pos = (50, 60)
                                                    putText_notok_ok("CAM_CAP_I3 is NotOK",original_image, pos)
                                        ...
                                        if position == "4":#=============== I5                                            
                                            ...
                                            if HLA_PostionCheck_pos4 == "OK" and CAM_CAP_NUMBER_STATUS_POS4 == "OK" and class_check_cam1 is True:
                                                ...
                                                if CAM_CAP_NUMBER_STATUS_POS4 == "NOT OK" or class_check_cam1 is False :
                                                    pos = (50, 60)
                                                    putText_notok_ok("CAM_CAP_I4 is NotOK",original_image, pos)
                                        ...
                                        if position == "5":#=============== E4                                            
                                            ...
                                            if HLA_PostionCheck_pos5 == "OK" and CAM_CAP_NUMBER_STATUS_POS5 == "OK" and class_check_cam1 is True:
                                                ...
                                                if CAM_CAP_NUMBER_STATUS_POS5 == "NOT OK" or class_check_cam1 is False :
                                                    pos = (50, 60)
                                                    putText_notok_ok("CAM_CAP_E4 is NotOK",original_image, pos)
                                            ...
                                            if HLA_PostionCheck_pos6 == "OK" and CAM_CAP_NUMBER_STATUS_POS6 == "OK" and class_check_cam1 is True:
                                              ...
                                              #  putText_notok_ok("CamCap is OK",original_image, pos)
                                                ...
                                                if CAM_CAP_NUMBER_STATUS_POS6 == "NOT OK" or class_check_cam1 is False :
                                                    pos = (50, 60)
                                                    putText_notok_ok("CAM_CAP_E3 is NotOK",original_image, pos)
                                            ...
                                            if HLA_PostionCheck_pos7 == "OK" and CAM_CAP_NUMBER_STATUS_POS7 == "OK" and class_check_cam1 is True:
                                               ...
                                               # putText_notok_ok("CamCap is OK",original_image, pos)
                                                ...
                                                if CAM_CAP_NUMBER_STATUS_POS7 == "NOT OK" or class_check_cam1 is False :
                                                    pos = (50, 60)
                                                    putText_notok_ok("CAM_CAP_E2 is NotOK",original_image, pos)
                                        ...
                                        if position == "8":#=============== E1                                            
                                            ...
                                            if HLA_PostionCheck_pos8 == "OK" and CAM_CAP_NUMBER_STATUS_POS8 == "OK" and class_check_cam1 is True:
                                                ...
                                                if CAM_CAP_NUMBER_STATUS_POS8 == "NOT OK" or class_check_cam1 is False :
                                                    pos = (50, 60)
                                                    putText_notok_ok("CAM_CAP_E1 is NotOK",original_image, pos)
                               ...
                               # pdfFIle_Name = start_pdf(OVREALL_STATUS,OVERALL_CAM_CAP_RESULT,OVERALL_HLA_RESULT, Engine_no,engine_folder_path)
                                ...
                                logger.debug(f"4_Cylinder process done for Engine_no {Engine_no} and OVREALL_STATUS is {OVREALL_STATUS}")
                                for i in img_list :
                                    if "POS_1.jpg" in i:
                                        os.remove(os.path.join(CAM_IMAGE,i))
                                    elif "POS_2.jpg" in i:
                    ...
                    if Engine_Type == "3_Cylinder":
                        try:
                            if len(img_list) >= 6:
                                ...
                                update_vision_overall_Status(OVREALL_STATUS)
                                #pdfFIle_Name = start_pdf(OVREALL_STATUS,OVERALL_CAM_CAP_RESULT,OVERALL_HLA_RESULT, Engine_no,engine_folder_path)
                                logger.debug(f"3_Cylinder process done for Engine_no {Engine_no} and OVREALL_STATUS is {OVREALL_STATUS}")
                                for i in img_list :
                                    if "POS_1.jpg" in i:
                                        os.remove(os.path.join(CAM_IMAGE,i))
                                    elif "POS_2.jpg" in i:
