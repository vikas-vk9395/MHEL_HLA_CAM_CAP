...
config_path = "C:/Users/mahindra/insightzz/ALGORITHM_NEW_HLA/ALGORITHAM/APP_CONFIG.xml"
if DEMO_RUN_FLAG:
...
NOT_OK_SAVED_FOLDER_PATH = "D:/NOT_OK_SAVED_FOLDER_PATH/"
if DEMO_RUN_FLAG:
...
def get_centroid(xmin, xmax, ymin, ymax):  # NOTOK
...
def putText_notok_ok(textMsg,frame, pos):
    try:
        if textMsg == "CamCap is NotOK" or textMsg == "HAL is NotOK":
            position = pos
            text = textMsg
            font_scale = 2
            #color = (255, 255, 255)
    ...
    try:
        if Position == "1":  # I2 position check
            ...
            for smalllabellist in OBJECT_LIST:
                ...
                if smalllabellist[2] < 630: # 500 # Left-side detection
                    ...
                    elif smalllabellist[0] == 'HLA_ROD_TOP' and ymin > 35:
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    thresholdPixel_LeftSide_1 = 41#36#25#14
                    thresholdPixel_LeftSide_2 = 75#65#50
                    ...
                    # Left I2, LeftSide_Cet is -47, yminTL 103 ymaxTL: 332, ymaxRTL: 288, yminRTL: 52, thresholdPixel_LeftSide_1: 7, thresholdPixel_LeftSide_2: 50
                    #Left I2, LeftSide_Cet is -306, yminTL 278 ymaxTL: 568, ymaxRTL: 219, yminRTL: 16, thresholdPixel_LeftSide_1: 14, thresholdPixel_LeftSide_2: 50
                    #Left I2, LeftSide_Cet is 3, yminTL 245 ymaxTL: 537, ymaxRTL: 523, yminRTL: 266, thresholdPixel_LeftSide_1: 14, thresholdPixel_LeftSide_2: 50
                    #Left I2, LeftSide_Cet is -2, yminTL 209 ymaxTL: 501, ymaxRTL: 481, yminRTL: 225, thresholdPixel_LeftSide_1: 14, thresholdPixel_LeftSide_2: 50
                    #Left I2, LeftSide_Cet is 12, yminTL 243 ymaxTL: 537, ymaxRTL: 529, yminRTL: 275, thresholdPixel_LeftSide_1: 25, thresholdPixel_LeftSide_2: 50
                    #Left I2, LeftSide_Cet is 12, yminTL 243 ymaxTL: 537, ymaxRTL: 529, yminRTL: 275, thresholdPixel_LeftSide_1: 25, thresholdPixel_LeftSide_2: 50
                    # Left I2, LeftSide_Cet is 16, yminTL 255 ymaxTL: 549, ymaxRTL: 544, yminRTL: 292, thresholdPixel_LeftSide_1: 36, thresholdPixel_LeftSide_2: 50
                    #Left I2, LeftSide_Cet is -49, yminTL 213 ymaxTL: 501, ymaxRTL: 440, yminRTL: 177, thresholdPixel_LeftSide_1: 41, thresholdPixel_LeftSide_2: 50
                    #Left I2, LeftSide_Cet is -289, yminTL 259 ymaxTL: 548, ymaxRTL: 218, yminRTL: 10, thresholdPixel_LeftSide_1: 41, thresholdPixel_LeftSide_2: 50
                    #Left I2, LeftSide_Cet is -45, yminTL 230 ymaxTL: 515, ymaxRTL: 456, yminRTL: 199, thresholdPixel_LeftSide_1: 41, thresholdPixel_LeftSide_2: 50
                    #Left I2, LeftSide_Cet is -81, yminTL 103 ymaxTL: 390, ymaxRTL: 298, yminRTL: 33, thresholdPixel_LeftSide_1: 41, thresholdPixel_LeftSide_2: 65
                    #Left I2, LeftSide_Cet is -56, yminTL 216 ymaxTL: 502, ymaxRTL: 434, yminRTL: 172, thresholdPixel_LeftSide_1: 41, thresholdPixel_LeftSide_2: 65
            ...
            try:              
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    thresholdPixel_RightSide_1 = 57#45#35
        ...
        if Position == "2":  # I3 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    hla_rod_top_L = hla_label_dict_left.get('1')
                    xminRTL, yminRTL, xmaxRTL, ymaxRTL,result, Lcx, Lcy = hla_rod_top_L[1:8]
                    thresholdPixel_LeftSide_1 = 35#30#27#22#15#10#1
                    thresholdPixel_LeftSide_2 = 140#130#110#101#95
                    ...
                    #Left I4, LeftSide_Cet is -77 ymaxTL: 519, yminTL 229 yminRTL 192 ymaxRTL: 402, thresholdPixel_LeftSide_1: 38, thresholdPixel_LeftSide_2: 115
            ...
            try:
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    RightSide_Cord = xminRTR - xminTR
                    thresholdPixel_RightSide_1 = 68#60#55#47#40#20
                    thresholdPixel_RightSide_2 = 110#102#90#70
                    HlaSize = ymaxTR -yminTR
                    ...
                    logger.debug("HLA_TOP or HLA_ROD_TOP missing on the right side.")
        ...
        if Position == "3":  # I4 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    thresholdPixel_LeftSide_1 = 43#38#31#26#15
                    thresholdPixel_LeftSide_2 = 120#115#90#85
                    HlaSize = ymaxTL -yminTL
                    ymin_L_Value = yminTL -yminRTL
                    ymax_L_Value = ymaxTL -ymaxRTL
                    LeftSide_Cet = Lcy - cy 
            ...
            try:
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    RightSide_Cord = xminRTR - xminTR
                    thresholdPixel_RightSide_1 = 50#40#30
                    thresholdPixel_RightSide_2 = 117#110#105
                    HlaSize = ymaxTR -yminTR
                    ymin_R_Value = yminTR -yminRTR
                    ymax_R_Value = ymaxTR -ymaxRTR
        ...
        if Position == "4":  # I5 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    thresholdPixel_LeftSide_1 = 28#20#1
                    thresholdPixel_LeftSide_2 = 120#110
                    HlaSize = ymaxTL -yminTL
                    ymin_L_Value = yminTL -yminRTL
                    ymax_L_Value = ymaxTL -ymaxRTL
            ...
            try:
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    RightSide_Cord = xminRTR - xminTR
                    thresholdPixel_RightSide_1 = 128#122#117#110#80
                    thresholdPixel_RightSide_2 = 40#30
                    HlaSize = ymaxTR -yminTR
                    ymin_R_Value = yminTR -yminRTR
                    ymax_R_Value = ymaxTR -ymaxRTR
                    RightSide_Cet = cy -Rcy
        ...
        if Position == "5":  # E4 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    hla_rod_top_L = hla_label_dict_left.get('1')
                    xminRTL, yminRTL, xmaxRTL, ymaxRTL,result, Lcx, Lcy = hla_rod_top_L[1:8]
                    thresholdPixel_LeftSide_1 =  37#27#22#10#5
                    thresholdPixel_LeftSide_2 = 134# 120#105#97
                    HlaSize = ymaxTL -yminTL
                    ymin_L_Value = yminTL -yminRTL
                    ymax_L_Value = ymaxTL -ymaxRTL
            ...
            try:
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    RightSide_Cord = xminRTR - xminTR
                    thresholdPixel_RightSide_1 = 94#86#82#75#65
                    thresholdPixel_RightSide_2 = 70#50
                    HlaSize = ymaxTR - yminTR
                    ymin_R_Value = yminTR -yminRTR
                    ymax_R_Value = ymaxTR -ymaxRTR
        ...
        if Position == "6":  # E3 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    hla_rod_top_L = hla_label_dict_left.get('1')
                    xminRTL, yminRTL, xmaxRTL, ymaxRTL,result, Lcx, Lcy = hla_rod_top_L[1:8]
                    thresholdPixel_LeftSide_1 = 32#21#9#5#2
                    thresholdPixel_LeftSide_2 = 135#125#115#105
                    HlaSize = ymaxTL - yminTL
                    ymin_L_Value = yminTL -yminRTL
                    ymax_L_Value = ymaxTL -ymaxRTL
            ...
            try:  
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    RightSide_Cord = xminRTR - xminTR
                    thresholdPixel_RightSide_1 = 95#82#81#66#60
                    thresholdPixel_RightSide_2 = 71#65#60#35#25#15#65
                    HlaSize = ymaxTR - yminTR
                    ymin_R_Value = yminTR -yminRTR
                    ymax_R_Value = ymaxTR -ymaxRTR
        ...
        if Position == "7":  # E2 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    xminRTL, yminRTL, xmaxRTL, ymaxRTL,result, Lcx, Lcy = hla_rod_top_L[1:8]
                    HlaSize = ymaxTL - yminTL
                    thresholdPixel_LeftSide_1 = 30#21#15#6#4#1#70
            ...
            try:
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    RightSide_Cord = xminRTR - xminTR
                    thresholdPixel_RightSide_1 = 80#70#60
                    thresholdPixel_RightSide_2 = 84#80#70#61#57#45
                    HlaSize = ymaxTR - yminTR
                    ymin_R_Value = yminTR -yminRTR
                    ymax_R_Value = ymaxTR -ymaxRTR
                    RightSide_Cet = cy -Rcy
        ...
        if Position == "8":  # E1 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    thresholdPixel_LeftSide_1 = 22#15#10#7#1
                    thresholdPixel_LeftSide_2 = 130#120#112
                    HlaSize = ymaxTL - yminTL
                    ymin_L_Value = yminTL -yminRTL
                    ymax_L_Value = ymaxTL -ymaxRTL
            ...
            try:              
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    thresholdPixel_RightSide_2 = 52#45#40#30
                    HlaSize = ymaxTR - yminTR
                    ymin_R_Value = yminTR -yminRTR
                    ymax_R_Value = ymaxTR -ymaxRTR
                    RightSide_Cet = cy -Rcy
...
def HLA_PositionCheck_WITH_ROD_4CYLINDER_C50(Position, OBJECT_LIST, original_image): 
    ...
    try:
        if Position == "1":  # I2 position check
            ...
            for smalllabellist in OBJECT_LIST:
                # Unpack basic values
                className, xmin, ymin, xmax, ymax = smalllabellist[0:5]

                # Find the cam cap center (split reference)
                if className in ["CAM_CAP_OK", "CAM_CAP_OK_MISSING"]:
                    className, xmin, ymin, xmax, ymax, score, xCentor, yCentor = smalllabellist[0:8]
                    capThreshold_xCentor = yCentor
                    continue  # skip to next loop after setting threshold

            # Second loop to split left vs right
            for smalllabellist in OBJECT_LIST:
                className, xmin, ymin, xmax, ymax, score, xCentor, yCentor = smalllabellist[0:8]

                if capThreshold_xCentor is None:
                    capThreshold_xCentor = 530
                   # raise ValueError("No CAM_CAP_OK or CAM_CAP_OK_MISSING found to set threshold.")

                if yCentor < capThreshold_xCentor:  # Left side
                    if className in ['HLA_TOP', 'HLA_3CYL']:
                        hla_label_dict_left['0'] = smalllabellist
                    elif className == 'HLA_ROD_TOP' and ymax > 100: #Ymin -60 #5
                        hla_label_dict_left['1'] = smalllabellist
                else:  # Right side
                    if className in ['HLA_TOP', 'HLA_3CYL']:
                        hla_label_dict_right['0'] = smalllabellist
                    elif className == 'HLA_ROD_TOP' and ymin < 1050: #930
                        hla_label_dict_right['1'] = smalllabellist
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    thresholdPixel_LeftSide_2 = 33#30#50#47
                    LeftSide_Cet = Lcy - cy   
        ...
        if Position == "2":  # I3 position check
            ...
            # Second loop to split left vs right
            for smalllabellist in OBJECT_LIST:
                className, xmin, ymin, xmax, ymax, score, xCentor, yaCentor = smalllabellist[0:8]

                if capThreshold_xCentor is None:
                    capThreshold_xCentor = 500
                   # raise ValueError("No CAM_CAP_OK or CAM_CAP_OK_MISSING found to set threshold.")

                if yCentor < capThreshold_xCentor:  # Left side
                    if className in ['HLA_TOP', 'HLA_3CYL']:
                        hla_label_dict_left['0'] = smalllabellist
                    elif className == 'HLA_ROD_TOP':
                        hla_label_dict_left['1'] = smalllabellist
                else:  # Right side
                    if className in ['HLA_TOP', 'HLA_3CYL']:
                        hla_label_dict_right['0'] = smalllabellist
        ...
        if Position == "5":  # E4 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    if yminTL < (yminRTL - thresholdPixel_LeftSide_1) or ymaxTL > (ymaxRTL + thresholdPixel_LeftSide_2) or SizeOf_cy_line > 27 or Check_Line_distance_with_hla > 93 or Check_Line_distance_with_hla_ymin < 90:
                        logger.debug(f"HLA_POSTION_LEFT = NOT OK")
                        HLA_POSTION_LEFT = "NOT OK"
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTL, yminTL), (xmaxTL, ymaxTL), color, 12)
            ...
            try:
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    if yminTR < (yminRTR - thresholdPixel_RightSide_1) or ymaxTR > (ymaxRTR + thresholdPixel_RightSide_2) or SizeOf_cy_line > 19 or Check_Line_distance_with_hla > 89 or Check_Line_distance_with_hla_ymin < 80:
                        HLA_POSTION_RIGHT = "NOT OK"
                        logger.debug(f"HLA_POSTION_RIGHT = NOT OK")
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTR, yminTR), (xmaxTR, ymaxTR), color, 12)
        ...
        if Position == "6":  # E3 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    logger.debug(f"Left E3,LeftSide_Cet_HLA_PositionCheck_WITH_ROD_4CYLINDER_C50 is SizeOf_cy_line is {SizeOf_cy_line} Check_Line_distance_with_hla is {Check_Line_distance_with_hla},Check_Line_distance_with_hla_ymin is {Check_Line_distance_with_hla_ymin} Check_Line_distance_with_hla is {Check_Line_distance_with_hla}, Check_Line_distance_with_hla_ymin is {Check_Line_distance_with_hla_ymin} ymaxTL: {ymaxTL},yminTL {yminTL} yminRTL {yminRTL} ymaxRTL: {ymaxRTL}, "
                                 f"thresholdPixel_LeftSide_1: {thresholdPixel_LeftSide_1}, "
                                 f"thresholdPixel_LeftSide_2: {thresholdPixel_LeftSide_2}")
              
                    if yminTL < (yminRTL - thresholdPixel_LeftSide_1) or ymaxTL > (ymaxRTL + thresholdPixel_LeftSide_2) or SizeOf_cy_line > 20 or Check_Line_distance_with_hla > 93 or Check_Line_distance_with_hla_ymin < 80:
                        logger.debug(f"HLA_POSTION_LEFT = NOT OK")
                        HLA_POSTION_LEFT = "NOT OK"
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTL, yminTL), (xmaxTL, ymaxTL), color, 12)
            ...
            try:  
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    if yminTR < (yminRTR - thresholdPixel_RightSide_1) or ymaxTR > (ymaxRTR + thresholdPixel_RightSide_2) or SizeOf_cy_line > 21 or Check_Line_distance_with_hla > 93 or Check_Line_distance_with_hla_ymin < 80: 
                        HLA_POSTION_RIGHT = "NOT OK"
                        logger.debug(f"HLA_POSTION_RIGHT = NOT OK")
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTR, yminTR), (xmaxTR, ymaxTR), color, 12)
        ...
        if Position == "7":  # E2 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    if yminTL < (yminRTL - thresholdPixel_LeftSide_1) or ymaxTL > (ymaxRTL + thresholdPixel_LeftSide_2) or SizeOf_cy_line > 25 or Check_Line_distance_with_hla > 90 or Check_Line_distance_with_hla_ymin < 80:
                        logger.debug(f"HLA_POSTION_LEFT = NOT OK")
                        HLA_POSTION_LEFT = "NOT OK"
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTL, yminTL), (xmaxTL, ymaxTL), color, 12)
            ...
            try:
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    if yminTR < (yminRTR - thresholdPixel_RightSide_2) or ymaxTR > (ymaxRTR + thresholdPixel_RightSide_1) or SizeOf_cy_line > 18 or Check_Line_distance_with_hla > 95 or Check_Line_distance_with_hla_ymin < 80:
                        HLA_POSTION_RIGHT = "NOT OK"
                        logger.debug(f"HLA_POSTION_RIGHT = NOT OK")
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTR, yminTR), (xmaxTR, ymaxTR), color, 12)
        ...
        if Position == "8":  # E1 position check
            ...
            for smalllabellist in OBJECT_LIST:
                ...
                if yCentor < capThreshold_xCentor:  # Left side
                    ...
                    if className in ['HLA_TOP', 'HLA_3CYL'] and ymin < 1050:
                        if smalllabellist[1] < 950:
                            hla_label_dict_right['0'] = smalllabellist
                    elif className == 'HLA_ROD_TOP':
                        hla_label_dict_right['1'] = smalllabellist
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    if yminTL < (yminRTL - thresholdPixel_LeftSide_1) or ymaxTL > (ymaxRTL + thresholdPixel_LeftSide_2) or SizeOf_cy_line > 19 or Check_Line_distance_with_hla > 90 or Check_Line_distance_with_hla_ymin < 85:
                        logger.debug(f"HLA_POSTION_LEFT = NOT OK")
                        HLA_POSTION_LEFT = "NOT OK"
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTL, yminTL), (xmaxTL, ymaxTL), color, 12)
            ...
            try:              
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    if yminTR < (yminRTR - thresholdPixel_RightSide_2) or ymaxTR > (ymaxRTR + thresholdPixel_RightSide_1) or SizeOf_cy_line > 21 or Check_Line_distance_with_hla > 94 or Check_Line_distance_with_hla_ymin < 85:
                        HLA_POSTION_RIGHT = "NOT OK"
                        logger.debug(f"HLA_POSTION_RIGHT = NOT OK")
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTR, yminTR), (xmaxTR, ymaxTR), color, 12)
        ...
        if Position == "1":  # I1 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    #Left I1, HlaSize is 253 yminTL: 141  ymaxTL: 394, ymaxRTL: 390, xminTL: 1395, thresholdPixel_LeftSide_1: 5, thresholdPixel_LeftSide_2: 70
                    #Left I1, HlaSize is 254 yminTL: 221  ymaxTL: 475, ymaxRTL: 475, xminTL: 1387, thresholdPixel_LeftSide_1: 5, thresholdPixel_LeftSide_2: 70
                    #Left I1, HlaSize is 259 yminTL: 276  ymaxTL: 535, ymaxRTL: 541, xminTL: 1357, thresholdPixel_LeftSide_1: 5, thresholdPixel_LeftSide_2: 70
        ...
        if Position == "2":  # I2 position check
            ...
            try:
                ...
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    xminRTL, yminRTL, xmaxRTL, ymaxRTL = hla_rod_top_L[1:5]
                    thresholdPixel_LeftSide_1 = 20
                    thresholdPixel_LeftSide_2 = 54#56#60#64#56#50 #20
                    HlaSize = ymaxTL - yminTL   #ok 239   # nok -172
                    if ymaxTL < 375:
                        thresholdPixel_LeftSide_2 = 60
                    ...
                    #Left I2, HlaSize is 261  ymaxTL: 379, ymaxRTL: 325, xminTL: 1370, thresholdPixel_LeftSide_1: 20, thresholdPixel_LeftSide_2: 50
                    #Left I2, HlaSize is 260  ymaxTL: 343, ymaxRTL: 292, xminTL: 1310, thresholdPixel_LeftSide_1: 20, thresholdPixel_LeftSide_2: 50
                    #Left I2, HlaSize is 256  ymaxTL: 403, ymaxRTL: 352, xminTL: 1337, thresholdPixel_LeftSide_1: 20, thresholdPixel_LeftSide_2: 50
                    #Left I2, HlaSize is 259  ymaxTL: 414, ymaxRTL: 363, xminTL: 1350, thresholdPixel_LeftSide_1: 20, thresholdPixel_LeftSide_2: 50
                    #Left I2, HlaSize is 258  ymaxTL: 416, ymaxRTL: 365, xminTL: 1347, thresholdPixel_LeftSide_1: 20, thresholdPixel_LeftSide_2: 50
                    #Left I2, HlaSize is 256  ymaxTL: 356, ymaxRTL: 304, xminTL: 1375, thresholdPixel_LeftSide_1: 20, thresholdPixel_LeftSide_2: 50
                    #Left I2, HlaSize is 245  ymaxTL: 327, ymaxRTL: 264, xminTL: 1314, thresholdPixel_LeftSide_1: 20, thresholdPixel_LeftSide_2: 50
        ...
        if Position == "3":  # I3 position check
            ...
            try:              
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    #Right I3,HlaSize is 225 yminTR: 725, yminRTR: 773, thresholdPixel_RightSide_1: 50, thresholdPixel_RightSide_2: 20
        ...
        if Position == "4":  # E3 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    #Left E3,Check_Line_distance_with_hla is 90 Check_Line_distance_with_hla_ymin is 99 SizeOf_cy_line is 5 ymaxTL: 474, ymaxRTL: 438, xminTL: 675, thresholdPixel_LeftSide_1: 80, thresholdPixel_LeftSide_2: 70
  

                    if ymaxTL < (ymaxRTL - thresholdPixel_LeftSide_1) or ymaxTL > (ymaxRTL + thresholdPixel_LeftSide_2) or Check_Line_distance_with_hla < 60 or Check_Line_distance_with_hla > 109 or Check_Line_distance_with_hla_ymin < 82 or Check_Line_distance_with_hla_ymin > 144 or SizeOf_cy_line > 18:  #ok-13
                        logger.debug(f"HLA_POSTION_LEFT = NOT OK")
                        HLA_POSTION_LEFT = "NOT OK"
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTL, yminTL), (xmaxTL, ymaxTL), color, 12)
            ...
            try:
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    if yminTR < 765:
                        Check_Line_distance_with_hla_ymin = Check_Line_distance_with_hla_ymin + 10
                    ...
                    #nok Right E3, Check_Line_distance_with_hla is 81 Check_Line_distance_with_hla_ymin is 98 SizeOf_cy_line 8 yminTR: 754, yminRTR: 792, thresholdPixel_RightSide_1: 72, thresholdPixel_RightSide_2: 40
                    #Right E3, Check_Line_distance_with_hla is 91 Check_Line_distance_with_hla_ymin is 76 SizeOf_cy_line -7 yminTR: 748, yminRTR: 757, thresholdPixel_RightSide_1: 72, thresholdPixel_RightSide_2: 40
                    #Right E3, Check_Line_distance_with_hla is 93 Check_Line_distance_with_hla_ymin is 80 SizeOf_cy_line -6 yminTR: 747, yminRTR: 754, thresholdPixel_RightSide_1: 72, thresholdPixel_RightSide_2: 40
        ...
        if Position == "5":  # E2 position check
            ...
            try:
                ...
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    #Left E2, Check_Line_distance_with_hla is 65 Check_Line_distance_with_hla_ymin is 126 SizeOf_cy_line is 30 ymaxTL: 343, ymaxRTL: 302, xminTL: 572, thresholdPixel_LeftSide_1: 70, thresholdPixel_LeftSide_2: 69

                    if ymaxTL < (ymaxRTL - thresholdPixel_LeftSide_1) or ymaxTL > (ymaxRTL + thresholdPixel_LeftSide_2) or Check_Line_distance_with_hla < 70 or Check_Line_distance_with_hla > 97 or Check_Line_distance_with_hla_ymin < 90 or SizeOf_cy_line > 30:   #ok-16
                        logger.debug(f"HLA_POSTION_LEFT = NOT OK")
                        HLA_POSTION_LEFT = "NOT OK"
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTL, yminTL), (xmaxTL, ymaxTL), color, 12)
            ...
            try:
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    #Right E2, Check_Line_distance_with_hla is 90 Check_Line_distance_with_hla_ymin is 98 SizeOf_cy_line is 4 yminTR: 657, yminRTR: 664, thresholdPixel_RightSide_1: 65, thresholdPixel_RightSide_2: 37
                    #Right E2, Check_Line_distance_with_hla is 391 Check_Line_distance_with_hla_ymin is -181 SizeOf_cy_line is -286 yminTR: 774, yminRTR: 798, thresholdPixel_RightSide_1: 65, thresholdPixel_RightSide_2: 37
                    ...
                    if yminTR < (yminRTR - thresholdPixel_RightSide_1) or yminTR > (yminRTR + thresholdPixel_RightSide_2) or Check_Line_distance_with_hla < 82 or Check_Line_distance_with_hla > 106 or Check_Line_distance_with_hla_ymin < 70 or Check_Line_distance_with_hla_ymin > 99 or SizeOf_cy_line > 15:
                        HLA_POSTION_RIGHT = "NOT OK"
                        logger.debug(f"HLA_POSTION_RIGHT = NOT OK")
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTR, yminTR), (xmaxTR, ymaxTR), color, 12)
        ...
        if Position == "6":  # E1 position check
            ...
            try:
                if '0' in hla_label_dict_left and '1' in hla_label_dict_left:
                    ...
                    #Left E1,Check_Line_distance_with_hla is 99 Check_Line_distance_with_hla_ymin is 108  SizeOf_cy_line is 4 ymaxTL: 444, ymaxRTL: 386, xminTL: 680, thresholdPixel_LeftSide_1: 45, thresholdPixel_LeftSide_2: 81

                    #notok Left E1,Check_Line_distance_with_hla is 69 Check_Line_distance_with_hla_ymin is 119  SizeOf_cy_line is 25 ymaxTL: 386, ymaxRTL: 348, xminTL: 544, thresholdPixel_LeftSide_1: 45, thresholdPixel_LeftSide_2: 81


                    if ymaxTL < (ymaxRTL - thresholdPixel_LeftSide_1) or ymaxTL > (ymaxRTL + thresholdPixel_LeftSide_2) or Check_Line_distance_with_hla < 75 or Check_Line_distance_with_hla > 99 or Check_Line_distance_with_hla_ymin < 90 or Check_Line_distance_with_hla_ymin > 120 or SizeOf_cy_line > 30:#Check_Line_distance_with_hla 97
                        HLA_POSTION_LEFT = "NOT OK"
            ...
            try:      
                if '0' in hla_label_dict_right and '1' in hla_label_dict_right:
                    ...
                    #Right E1,Check_Line_distance_with_hla is 90 Check_Line_distance_with_hla_ymin is 108 SizeOf_cy_line is 2, yminTR: 779, yminRTR: 789, thresholdPixel_RightSide_1: 58, thresholdPixel_RightSide_2: 15

            
                    if yminTR < (yminRTR - thresholdPixel_RightSide_1) or yminTR > (yminRTR + thresholdPixel_RightSide_2) or Check_Line_distance_with_hla < 83  or Check_Line_distance_with_hla > 115 or Check_Line_distance_with_hla_ymin < 78 or Check_Line_distance_with_hla_ymin > 124 or SizeOf_cy_line > 22:
                        HLA_POSTION_RIGHT = "NOT OK"
                        logger.debug(f"HLA_POSTION_RIGHT = NOT OK")
                        color = (0, 0, 255)
                        cv2.rectangle(original_image, (xminTR, yminTR), (xmaxTR, ymaxTR), color, 12)
...
def drawPolygonPoints(image,data_list):  # HLA CAMCAP
...
def createPDF(image_file_list,final_status, OVERALL_CAM_CAP_RESULT,OVERALL_HLA_RESULT, engine_number,DateTime,SavedirName):
    try:
        ...
        pdf.image("C:/Users/mahindra/insightzz/ALGORITHM_NEW_HLA/HLA_UI/LOGO/Mahindra-Mahindra-New-Logo.png", x=10, y=5, w=50, h=30, type='png')
...
def run(maskRCNNObj):
    ...
    def get_engine_number(engineNo):
        db_fetch = None #OVER_SEALANTSTATUS= 
        cur = None
        rowCount = 0
        try:
            db_fetch = pymysql.connect(host=DB_HOST, user=DB_USER, passwd=DB_PASS, db=DB_NAME)
            cur = db_fetch.cursor()
            query = "SELECT COUNT(*) AS RowCount FROM hla_cam_cap_temp_pdf_path_table WHERE ENGINE_NUMBER LIKE %s;"
            cur.execute(query, (f"{engineNo}%",))
            print("query is:",query)
            #cur.execute(query) 
            data_set = cur.fetchall()
            for row in range(len(data_set)):
                rowCount = data_set[row][0]
            
        except Exception as e:
            print(e)


    CAM_IMAGE = "C:/Users/mahindra/insightzz/ALGORITHM_NEW_HLA/ALGORITHAM/IMG/"
    ...
    try:
        while True:
            ...
            Engine_no, Engine_Type = "0301AAW02870N_NVSZJ85032","3_Cylinder"
            if DEMO_RUN_FLAG is False:
                            ...
                            if len(img_list) == 8:
                                ...
                                for img_name in img_list:
                                    ...
                                    if OBJECT_LIST == [] or OBJECT_LIST is None:
                                        ...
                                        #============================= Postion 2 ==================================#
                                        if position == "1":#=============== I2
                                            #CAM_CAP_NUMBER_STATUS_POS1,original_image = HLA_CAM_CAP_INSPECTION_4CYLINDER(position,OBJECT_LIST,original_image)
                                            ...
                                            if HLA_PostionCheck_pos1 == "OK" and CAM_CAP_NUMBER_STATUS_POS1 == "OK" and class_check_cam1 is True:
                                              ...
                                              # putText_notok_ok("CamCap is OK",original_image, pos)
                                                ...
                                                if HLA_PostionCheck_pos1 == "NOT OK":
                                                    pos = (50, 60)
                                                    putText_notok_ok("HAL is NotOK",original_image, pos)
                                        ...
                                        if position == "2":#=============== I3  CAM4_
                                           # CAM_CAP_NUMBER_STATUS_POS2,original_image = HLA_CAM_CAP_INSPECTION_4CYLINDER(position,OBJECT_LIST,original_image)
                                            ...
                                            #============================= Postion 4 ==================================#
                                        if position == "3":#=============== I4
                                            #CAM_CAP_NUMBER_STATUS_POS3,original_image = HLA_CAM_CAP_INSPECTION_4CYLINDER(position,OBJECT_LIST,original_image)
                                        ...
                                        if position == "4":#=============== I5
                                            #CAM_CAP_NUMBER_STATUS_POS4,original_image = HLA_CAM_CAP_INSPECTION_4CYLINDER(position,OBJECT_LIST,original_image)
                                        ...
                                        if position == "5":#=============== E4
                                           # CAM_CAP_NUMBER_STATUS_POS5,original_image = HLA_CAM_CAP_INSPECTION_4CYLINDER(position,OBJECT_LIST,original_image)
                                        ...
                                        if position == "6":#=============== E3
                                            #CAM_CAP_NUMBER_STATUS_POS6,original_image = HLA_CAM_CAP_INSPECTION_4CYLINDER(position,OBJECT_LIST,original_image)
                                        ...
                                        if position == "7": #=============== E2
                                            #CAM_CAP_NUMBER_STATUS_POS7,original_image = HLA_CAM_CAP_INSPECTION_4CYLINDER(position,OBJECT_LIST,original_image)
                                        ...
                                        if position == "8":#=============== E1
                                            #CAM_CAP_NUMBER_STATUS_POS8,original_image = HLA_CAM_CAP_INSPECTION_4CYLINDER(position,OBJECT_LIST,original_image)
                                            ...
                                            if POS_8_E1_STATUS == "NOT OK":
                                                ...
                                                current_datetime = datetime.datetime.now()
                                                formatted_dateime = current_datetime.strftime("%Y-%m-%d_%H-%M-%S")
                                                # Generate image paths including the folder structure   NOT OK
                                ...
                                for img_name in img_list:
                                    ...
                                    if OBJECT_LIST == [] or OBJECT_LIST is None:
                                        ...
                                        if position == "1":#=============== I2
                                           ...
                                           # if all(any(class_name in sublist[0] for sublist in OBJECT_LIST) for class_name in CLASS_NAME_OK_LIST_I1_3C):
                                                print("NOTOK")
                                                class_check_cam1 = False
                                            else:
                                                class_check_cam1 = True#False
                                        ...
                                        if position == "2":
                                            ...
                                            #if all(any(class_name in sublist[0] for sublist in OBJECT_LIST) for class_name in CLASS_NAME_OK_LIST_I2_3C):
                                                print("NOTOK")
                                                class_check_cam1 = False
                                            else:
                                                class_check_cam1 = True#False
                                        ...
                                        if position == "3":
                                            ...
                                            #if all(any(class_name in sublist[0] for sublist in OBJECT_LIST) for class_name in CLASS_NAME_OK_LIST_I3_3C):
                                                print("nOK")
                                                class_check_cam1 = False
                                            else:
                                                class_check_cam1 = True#False
                                        ...
                                        if position == "4":
                                           ...
                                           # if all(any(class_name in sublist[0] for sublist in OBJECT_LIST) for class_name in CLASS_NAME_OK_LIST_E3_3C):
                                                print("nOK")
                                                class_check_cam1 = False
                                            else:
                                                class_check_cam1 = True#False
                                        ...
                                        if position == "5":
                                            ...
                                            #if all(any(class_name in sublist[0] for sublist in OBJECT_LIST) for class_name in CLASS_NAME_OK_LIST_E2_3C):
                                                print("nOK")
                                                class_check_cam1 = False
                                            else:
                                                class_check_cam1 = True#False
                                        ...
                                        if position == "6":
                                            ...
                                            #if all(any(class_name in sublist[0] for sublist in OBJECT_LIST) for class_name in CLASS_NAME_OK_LIST_E1_3C):
                                                print("nOK")
                                                class_check_cam1 = False
                                            else:
                                                class_check_cam1 = True#False
...
def initializeLogger():
    ...
    try:
        ...
        # Define the log file format  True
        formatter = logging.Formatter('%(asctime)s - %(levelname)s - %(message)s')

        # Base directory for logs
        base_dir = "C:/Users/mahindra/insightzz/ALGORITHM_NEW_HLA/ALGORITHAM/LOG/"
